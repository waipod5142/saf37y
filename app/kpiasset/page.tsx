...
export default async function KPIAssetPage() {
  const countries = await getCountries();
  return (
    <div className="container mx-auto p-6">
      <Breadcrumbs items={[{ label: "ASSET KPI" }]} />
      ...
      <div className="mt-6 mb-8 flex items-start justify-between gap-6">
        <div className="flex-1">
          ...
          <p className="text-gray-600">
            Select a country to view asset tracking by site.
          </p>
        </div>
        <div className="flex-shrink-0">
          <QRCodeComponent value="https://www.saf37y.com/kpiasset" />
        </div>
      </div>
        ...
        {countries.map((country) => (
          ...
          >
            ...
            <CardContent className="space-y-4">
              ...
              <Link href={`/kpiasset/${country.code}`} className="block">
              ...
              <div className="pt-2 border-t">
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  {country.sites.map((site) => (
                    <Link
                      key={site}
                      href={`/kpiasset/${country.code}/${site.toLowerCase()}`}
                    >
                      <Badge
                        variant="outline"
