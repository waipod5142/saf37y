...
export default async function VisitorDashboardPage() {
  ...
  return (
    <div className="container mx-auto p-6">
      <Breadcrumbs items={[{ label: "Visitor Dashboard" }]} />
      ...
      <div className="mt-6 mb-8 flex items-start justify-between gap-6">
        ...
        <div className="flex-shrink-0">
          <QRCodeComponent value="https://www.saf37y.com/kpivisitor" />
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {countries.map((country) => (
          <Link key={country.code} href={`/kpivisitor/${country.code}`}>
            <Card className="hover:shadow-lg transition-all duration-200 border-2 hover:border-blue-300 cursor-pointer">
