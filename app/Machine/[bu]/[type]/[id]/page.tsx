...
export default async function MachinePage({
  ...
  return (
    <div className="max-w-4xl mx-auto p-2">
      <MachineTitle bu={normalizedBu} type={decodedType.toLowerCase()} id={decodedId} />
      <MachineOption bu={normalizedBu} type={decodedType.toLowerCase()} id={decodedId} />
      <MachineHeader bu={normalizedBu} type={decodedType.toLowerCase()} id={decodedId} />
      <MachineDetail bu={normalizedBu} type={decodedType.toLowerCase()} id={decodedId} />
