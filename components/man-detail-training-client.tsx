...
const getTrainingStatusStyle = (status: string) => {
  switch (status.toLowerCase()) {
    ...
    case 'pending':
      return { color: 'bg-orange-500 text-white', text: 'Pending / รอดำเนินการ' };
    case 'suspended':
...
export default function TrainingManDetailClient({ records }: TrainingManDetailClientProps) {
  ...
  if (!records || records.length === 0) {
    return (
      <div className="mb-6">
        <p className="text-sm text-green-500 mt-2">No Training records found for this employee.</p>
      </div>
    );
  }
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          <h3 className="text-lg font-semibold">
            Training Records ({showAllRecords ? records.length : 1} of {records.length} record{records.length > 1 ? 's' : ''})
          </h3>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-gray-700">ชื่อหลักสูตร / Course Name</p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="font-semibold text-gray-700">ชั่วโมง / Hours</p>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="font-semibold text-gray-700">คะแนน / Score</p>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-gray-700 mb-2">สถานะ / Status</p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-gray-700">วันที่อบรม / Training Date</p>
                      <p className="text-gray-600">{formatDate(record.trainingDate)}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-gray-700">วันหมดอายุ / Expiry Date</p>
                      <p className="text-gray-600">{formatDate(record.expiryDate)}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-gray-700">อัปเดตโดย / Updated By</p>
                      <p className="text-gray-600">{record.updateBy}</p>
                      <p className="text-xs text-gray-500">{formatDate(record.updateAt)}</p>
                    </div>
                  </div>
                  ...
                  {record.evidenceText && (
                    <div>
                      ...
                      <div className="bg-gray-50 p-3 rounded-md border-l-4 border-gray-500">
                        <p className="text-gray-700">{record.evidenceText}</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              {record.files && record.files.length > 0 && (
                <div className="mt-6 pt-6 border-t">
                  <p className="font-semibold text-gray-700 mb-4 flex items-center gap-2">
                    ...
                    ใบประกาศนียบัตรและเอกสาร / Certificates & Documents ({record.files.length})
                  </p>
