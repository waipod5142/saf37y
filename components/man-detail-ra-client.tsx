                ...
                <CardContent className="pt-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="font-semibold text-gray-700">
                              {t.ra?.observedName || "Observed Person"}
                            </p>
                      ...
                      {record.taskObserved && (
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="font-semibold text-gray-700 mb-2">
                              {t.ra?.taskObserved || "Task Observed"}
                            </p>
                    ...
                    <div className="space-y-4">
                      ...
                      {/* Agreement */}
                      {record.potentialDamageOrInjury && (
                        <div>
                          <p className="font-semibold text-gray-700 mb-2 flex items-center gap-2">
                            <ClipboardCheck className="h-5 w-5 text-blue-600" />
                            {t.ra?.potentialDamageOrInjury ||
                      ...
                      {record.complianceWI && (
                        <div>
                          <p className="font-semibold text-gray-700 mb-2 flex items-center gap-2">
                            <ClipboardCheck className="h-5 w-5 text-blue-600" />
                            {t.ra?.complianceWI || "Compliant to WI"}
                          </p>
                          <div className="bg-blue-50 p-3 rounded-md border-l-4 border-blue-500">
                            <p className="text-gray-700">
                              {record.complianceWI}
                      ...
                      {record.unsafeActs && (
                        <div>
                          <p className="font-semibold text-gray-700 mb-2 flex items-center gap-2">
                            <ClipboardCheck className="h-5 w-5 text-blue-600" />
                            {t.ra?.unsafeActs || "Unsafe action"}
                          </p>
                          <div className="bg-blue-50 p-3 rounded-md border-l-4 border-blue-500">
                            <p className="text-gray-700">{record.unsafeActs}</p>
                          </div>
                        </div>
                      )}
                      {/* Agreement */}
                      {record.goodBehaviours && (
                        <div>
                          <p className="font-semibold text-gray-700 mb-2 flex items-center gap-2">
                            <ClipboardCheck className="h-5 w-5 text-blue-600" />
                            {t.ra?.goodBehaviours || "Good behavior"}
                          </p>
                          <div className="bg-blue-50 p-3 rounded-md border-l-4 border-blue-500">
                            <p className="text-gray-700">
                              {record.goodBehaviours}
                      ...
                      {record.discussion && (
                        <div>
                          <p className="font-semibold text-gray-700 mb-2 flex items-center gap-2">
                            <ClipboardCheck className="h-5 w-5 text-blue-600" />
                            {t.ra?.discussion || "Discussion"}
                          </p>
                          <div className="bg-blue-50 p-3 rounded-md border-l-4 border-blue-500">
                            <p className="text-gray-700">{record.discussion}</p>
                          </div>
                        </div>
                      )}
                      {/* Agreement */}
                      {record.correctiveActions && (
                        <div>
                          <p className="font-semibold text-gray-700 mb-2 flex items-center gap-2">
                            <ClipboardCheck className="h-5 w-5 text-blue-600" />
                            {t.ra?.correctiveActions || "Corrective action"}
                          </p>
                          <div className="bg-blue-50 p-3 rounded-md border-l-4 border-blue-500">
                            <p className="text-gray-700">
                              {record.correctiveActions}
