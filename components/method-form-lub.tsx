...
const translations = {
  ...
  vn: {
    ...
    acknowledge:
      "3. Tôi hiểu và xác nhận cảnh báo này I understand and acknowledge this accident",
  ...
  lk: {
    ...
    acknowledge:
      "3. මම මෙම අනතුරු ඇඟවීම තේරුම් ගෙන පිළිගනිමි I understand and acknowledge this accident",
  ...
  bd: {
    ...
    other:
      "অন্যান্য________(অনুগ্রহ করে উল্লেখ করুন) Other________(Please specify)",
    ...
    acknowledge:
      "3. আমি এই সতর্কতা বুঝি এবং স্বীকার করি I understand and acknowledge this accident",
  ...
  kh: {
    ...
    acknowledge:
      "3. ខ្ញុំយល់ និងទទួលស្គាល់ការព្រមាននេះ I understand and acknowledge this accident",
