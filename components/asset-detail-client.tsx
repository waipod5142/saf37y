        ...
        <CardHeader className="pb-3">
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-center gap-2">
              <Badge className={`${getStatusBadgeColor(record.status)} text-white`}>
                {record.status}
              </Badge>
            </div>
          </div>
        ...
        {record.url && (
          <div className="mb-4 px-4">
            <Card className="border-2 border-gray-200 shadow-sm">
              ...
              <CardContent>
                <div
                  className="group relative aspect-square rounded-lg border-2 border-gray-200 overflow-hidden hover:border-blue-400 hover:shadow-xl transition-all duration-300 cursor-pointer bg-gray-50 max-w-md"
                  onClick={() => handleImageClick(record.url)}
                >
                  <img
                    src={formatImageUrl(record.url)}
                    alt="Asset image"
