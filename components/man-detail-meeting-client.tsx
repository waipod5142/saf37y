...
import { MeetingManRecord } from "@/types/man";
...
export default function MeetingManDetailClient({ records, bu }: MeetingManDetailClientProps) {
  ...
  const isWithinDeleteTimeWindow = (record: MeetingManRecord) => {
  ...
  if (!records || records.length === 0) {
    return (
      <div className="mb-6">
        <p className="text-sm text-blue-500 mt-2">No Meeting Form reports found for this machine.</p>
      </div>
    );
  }
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          <h3 className="text-lg font-semibold">
            Meeting Form Reports ({showAllRecords ? records.length : 1} of {records.length} record{records.length > 1 ? 's' : ''})
          </h3>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-gray-700">หมายเลขการประชุม / Meeting Number</p>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {record.images.map((imageUrl, imgIndex) => (
                      ...
                      >
                        <img
                          src={imageUrl}
                          alt={`Meeting Form Image ${imgIndex + 1}`}
      ...
      <Dialog open={isImageModalOpen} onOpenChange={setIsImageModalOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] p-0">
          <DialogHeader className="p-6 pb-0">
            <DialogTitle>Meeting Form Image</DialogTitle>
          </DialogHeader>
