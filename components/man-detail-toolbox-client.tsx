...
import { Calendar, User, MessageSquare, CheckCircle, FileText, Camera, ToggleLeftIcon, ToggleRightIcon, Trash2Icon } from "lucide-react";
...
export default function ToolboxManDetailClient({ records }: ToolboxManDetailClientProps) {
  ...
  if (!records || records.length === 0) {
    return (
      <div className="mb-6">
        <p className="text-sm text-red-500 mt-2">No Toolbox Talk reports found for this machine.</p>
      </div>
    );
  }
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          <h3 className="text-lg font-semibold">
            Toolbox Talk Reports ({showAllRecords ? records.length : 1} of {records.length} record{records.length > 1 ? 's' : ''})
          </h3>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="font-semibold text-gray-700">ผู้นำเสนอ / Presenter</p>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="font-semibold text-gray-700">หัวข้อ / Subject</p>
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full mx-4">
            <h3 className="text-lg font-semibold mb-4">Delete Toolbox Talk Report</h3>
            <p className="text-gray-600 mb-6">
              Are you sure you want to delete this Toolbox Talk report? This action will permanently delete the record and all associated images from storage.
            </p>
